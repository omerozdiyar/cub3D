...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/01/17 15:22:13 by eyagiz            #+#    #+#             */
/*   Updated: 2023/01/23 17:47:33 by eyagiz           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	player_move(t_game *game)
{
	if (game->key_w)
	{
		if (game->map[(int)(game->ray.posx + game->ray.dirx * game->msws)] \
			[(int)(game->ray.posy)] != '1')
			game->ray.posx += game->ray.dirx * game->msws;
		if (game->map[(int)(game->ray.posx)] \
			[(int)(game->ray.posy + game->ray.diry * game->msws)] != '1')
